		...
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				const data = `
					...
					<p>Welcome to my personal website! It is still under construction. Feel free to <a href='#contact'>contact me</a> as you wish! More content will be available soon. Enjoy it! I hope to see you soon. Cheers!</p>`;
				resolve(data);
			}, 10);
